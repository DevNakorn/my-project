    ...
    <>
        ...
        <div className="max-w-[500px] mx-auto border shadow-lg mt-[120px] p-14 rounded-3xl ">
            ...
            <form action="#" className="flex flex-col p-3">
                <input className="border rounded-lg m-2 h-10 p-3 duration-300 border-black hover:scale-105 hover:border-2" type="text" name="username" placeholder="Username " required/>                <input className="border rounded-lg m-2 h-10 p-3 duration-300 border-black hover:scale-105 hover:border-2" type="password" name="password" placeholder="Password" required/>                <div className="flex justify-center mt-4">
